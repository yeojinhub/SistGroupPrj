...
/**
 * public RunMainWindow : LoginForm window 실행하기 위한 전처리용 class
 * public class LoginForm : 로그인 form 구현
 * public class LoginFormEvt : 로그인 실행하는 이벤트 class
 * private JTextField idText : 사용자로부터 아이디 입력받음
 * private JPasswordField passText : 사용자로부터 비밀번호 입력받음
 * private JButton loginBtn : 버튼을 누르면 로그인
 */
